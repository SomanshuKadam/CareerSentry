...
import { demoCollectors, demoJobs, incident } from "@/lib/demo-data";
...
export default function CollectorsPage() {
  ...
  const totalRows = demoCollectors.reduce((total, collector) => total + collector.rowCount, 0);
